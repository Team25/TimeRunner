...
public class Entry {
    ...
    private boolean mIsVerifies;

    public Entry(long id, List<Comment> comments, String department, Timestamp inTime, Timestamp outTime, boolean isVerifies) {
        mId = id;
        mComments = comments;
        mDepartment = department;
        mInTime = inTime;
        mOutTime = outTime;
        mIsVerifies = isVerifies;
    }
